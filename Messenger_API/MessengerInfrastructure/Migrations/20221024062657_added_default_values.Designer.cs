...
namespace MessengerInfrastructure.Migrations
{
    ...
    [Migration("20221024062657_added_default_values")]
    partial class added_default_values
    {
            ...
            modelBuilder.Entity("MessengerInfrastructure.Entity.MessageEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2022, 10, 24, 6, 26, 57, 533, DateTimeKind.Utc).AddTicks(1084));
            ...
            modelBuilder.Entity("MessengerInfrastructure.Entity.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2022, 10, 24, 6, 26, 57, 533, DateTimeKind.Utc).AddTicks(2152));
